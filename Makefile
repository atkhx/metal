.PHONY: gpt2-mini-prepare gpt2-medium-prepare
...
gpt2-medium-prepare:
	...
	fetch "https://huggingface.co/gpt2-medium/resolve/main/config.json" "$(GPT2_MEDIUM_DIR)/config.json"; \
	fetch "https://huggingface.co/gpt2-medium/resolve/main/vocab.json" "$(GPT2_MEDIUM_DIR)/vocab.json"; \
	fetch "https://huggingface.co/gpt2-medium/resolve/main/merges.txt" "$(GPT2_MEDIUM_DIR)/merges.txt"; \
	fetch "https://huggingface.co/gpt2-medium/resolve/main/tokenizer_config.json" "$(GPT2_MEDIUM_DIR)/tokenizer_config.json"; \
	fetch "https://huggingface.co/gpt2-medium/resolve/main/special_tokens_map.json" "$(GPT2_MEDIUM_DIR)/special_tokens_map.json"; \
	fetch "https://huggingface.co/gpt2-medium/resolve/main/generation_config.json" "$(GPT2_MEDIUM_DIR)/generation_config.json"; \
	fetch "https://huggingface.co/gpt2-medium/resolve/main/model.safetensors" "$(GPT2_MEDIUM_WEIGHTS)"
